...
| `professionals` | professionals-list | 3 | 1 | 8 |
| `resources` | resources-list | 3 | 1 | 8 |

### Recent commits

- **(this commit)** 2026-08-19 - feat(professionals): add vegan-relevant professionals directory _(Gino Carrasco)_
