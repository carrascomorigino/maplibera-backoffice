...
- **(this commit)** 2026-08-21 - feat(professionals): add optional image gallery and video link _(Gino Carrasco)_
- `005a042` 2026-08-21 - fix: guard against missing images on legacy documents (#20) _(Gino Carrasco Mori)_
- `7803612` 2026-08-21 - feat(professionals): add vegan-relevant professionals directory (#19) _(Gino Carrasco Mori)_
- `6cc4858` 2026-08-21 - feat: replace single image fields with a 3-image gallery, add videoUrl (#18) _(Gino Carrasco Mori)_
- `d5b4393` 2026-08-20 - feat: add multi-select bulk delete to every list page (#17) _(Gino Carrasco Mori)_
- `2a255ce` 2026-08-20 - chore: updating local skills _(Gino Carrasco)_
