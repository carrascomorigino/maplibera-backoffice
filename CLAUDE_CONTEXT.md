...
- **(this commit)** 2026-08-17 - chore(context): add SessionStart hook that loads .claude-resume.md _(Gino Carrasco)_
- `364ad7a` 2026-08-17 - fix(context): use git's own trailer parser for the resume fields _(Gino Carrasco)_
- `c2a49ac` 2026-08-17 - feat(context): add .claude-resume.md for session-to-session handoff _(Gino Carrasco)_
