...
_Last updated: 2026-08-18 - commit `fd9d40c` on `main` - 32 commits total._
...
- `575ec0a` 2026-08-07 - Merge pull request #8 from carrascomorigino/feat/resources-module _(carrascomorigino)_
- `0ede749` 2026-08-07 - feat(resources): add Recursos module with category-based content and shared i18n components _(Gino Carrasco)_
- `fac39dc` 2026-08-06 - docs: add design spec for Resources module _(Gino Carrasco)_

### Files touched by the last commit

- `docs/superpowers/specs/2026-08-07-organizations-module-design.md`
- `src/app/app.html`
...
- `src/app/features/organizations/components/organization-list-item/organization-list-item.spec.ts`
...
- `src/app/features/organizations/organizations.routes.ts`
- `src/app/features/organizations/pages/organizations-list/organizations-list.page.html`
- `src/app/features/organizations/pages/organizations-list/organizations-list.page.spec.ts`
- `src/app/features/organizations/pages/organizations-list/organizations-list.page.ts`
- `src/app/features/organizations/services/organization.service.spec.ts`
...
_Working tree at generation time: 6 uncommitted change(s)._
