...
- **(this commit)** 2026-08-21 - chore: update package-lock.json for patch-level Angular CLI bumps _(Gino Carrasco)_
- `66d7608` 2026-08-21 - feat: replace single image fields with a 3-image gallery, add videoUrl _(Gino Carrasco)_
